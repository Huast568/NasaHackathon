        ...
        if self.channels == 1:
            ...
            while True:
                ...
                if not ret:
                    ...
                    return [self.audio_clip_left_R,
                            self.audio_clip_left_G,
                            self.audio_clip_left_B,
                            self.audio_clip_right_R,
                            self.audio_clip_right_G,
                            self.audio_clip_right_B]
...
def main(video_file=os.path.join(os.path.dirname(__file__), 'space_video.mp4')):
